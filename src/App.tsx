        ...
        <div className="w-full min-h-screen bg-cyber-dark text-slate-200 font-inter selection:bg-cyber-blue selection:text-black">
            ...
            <section id="home" className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden pt-20">
                ...
                >
                    ...
                    <h1 className="text-[3vw] sm:text-[1.5vw] md:text-3xl text-cyber-blue font-orbitron tracking-[0.05em] sm:tracking-[1em] mb-4 opacity-70">
                        WELCOME_PROTOCOL
                    </h1>
                    ...
                    <div className="mb-8">
                        <GradualSpacing
                            ...
                            className="text-[11vw] sm:text-[12vw] md:text-[13vw] lg:text-[13rem] font-orbitron font-black text-white leading-none tracking-tighter whitespace-nowrap"
                        />
                    </div>
