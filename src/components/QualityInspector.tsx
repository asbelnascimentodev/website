        ...
        <div className="w-full overflow-x-hidden">
            <div className="w-full max-w-[1200px] mx-auto px-4 py-8 md:py-16">
                ...
                >
                    ...
                    <div className="bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl w-full mb-10 md:mb-16">
                        <p className="text-sm sm:text-base md:text-xl leading-relaxed md:leading-loose text-slate-200 font-medium text-justify">
