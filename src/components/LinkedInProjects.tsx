        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            >
                <div className="absolute -top-6 left-6 z-10">
                    <span className="bg-slate-800 text-slate-400 text-sm font-bold px-4 py-1 rounded-full border border-white/10 shadow-xl">
                        ANTES
                    </span>
                </div>
                <div className="rounded-3xl overflow-hidden border border-white/5 bg-slate-900/40 backdrop-blur-sm grayscale opacity-70 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700 shadow-2xl">
                    <img
            ...
            >
                <div className="absolute -top-6 left-6 z-10">
                    <span className="bg-sky-500 text-white text-sm font-bold px-6 py-2 rounded-full border border-sky-400 shadow-[0_0_20px_rgba(14,165,233,0.5)] flex items-center gap-2">
                        <div className="w-2 h-2 bg-white rounded-full animate-pulse" />
                        DEPOIS
                    </span>
                </div>
                <div className="rounded-3xl overflow-hidden border-2 border-sky-400/30 bg-slate-900/60 backdrop-blur-md shadow-[0_0_40px_rgba(14,165,233,0.15)] group-hover:border-sky-400 group-hover:shadow-[0_0_50px_rgba(14,165,233,0.25)] transition-all duration-700">
                    <img
        ...
        >
            <div className="flex flex-col md:flex-row gap-10 items-center">
                <div className="flex-1">
                    <h4 className="text-2xl font-bold text-white mb-6">Destaques do Projeto</h4>
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {project.improvements.map((item, i) => (
                            <li key={i} className="flex items-start gap-3 text-slate-300">
                                <div className="mt-1.5 w-2 h-2 bg-sky-400 rounded-full shrink-0" />
                ...
                <div className="flex flex-col gap-4 shrink-0 w-full md:w-auto">
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                        <a
                            ...
                            className="w-full bg-slate-800 hover:bg-slate-700 text-white font-bold px-8 py-4 rounded-2xl flex items-center justify-center gap-3 transition-colors border border-white/10 shadow-xl group"
                        >
                            Ver Currículo Web
                    ...
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-full bg-sky-500 hover:bg-sky-400 text-white font-bold px-8 py-4 rounded-2xl flex items-center justify-center gap-3 transition-colors shadow-[0_10px_30px_rgba(14,165,233,0.3)]"
                        >
                            Ver No LinkedIn
