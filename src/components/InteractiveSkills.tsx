        ...
        <div className="w-full max-w-4xl mx-auto px-4">
            ...
            >
                ...
                <motion.div
                    ...
                    className="relative z-10 p-2 bg-white/5 rounded-full text-slate-400 group-hover:text-sky-400 transition-colors"
                >
                            ...
                            {skillCategories.map((category, idx) => (
                                ...
                                >
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 className="font-bold text-slate-100 italic">{category.title}</h4>
                                    </div>
