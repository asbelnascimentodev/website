    ...
    return (
        <div className="w-full">
            <motion.button
                ...
                className={cn(
                    "group relative w-full flex items-center justify-between p-4 xs:p-6 rounded-2xl transition-all duration-500",
            ...
            >
                ...
                <div className="flex items-center gap-3 xs:gap-4 relative z-10">
                    <div className="p-2 xs:p-3 bg-sky-500/20 rounded-xl text-sky-400">
                    ...
                    <div className="text-left">
                        ...
                        <p className="text-slate-400 text-[10px] xs:text-xs">Clique para ver meu stack tecnológico</p>
                    </div>
                </div>

                <motion.div
                    animate={{ rotate: isOpen ? 180 : 0 }}
                    className="relative z-10 p-1.5 xs:p-2 bg-white/5 rounded-full text-slate-400 group-hover:text-sky-400"
                >
                                ...
                                >
                                    ...
                                    <ul className="space-y-2">
                                        {category.skills.map((skill) => (
                                            <li key={skill} className="flex items-center gap-2 text-slate-400 text-xs md:text-sm">
                                                <div className="w-1.5 h-1.5 rounded-full bg-sky-500/50 shrink-0" />
